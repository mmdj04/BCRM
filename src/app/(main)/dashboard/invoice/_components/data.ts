...
export const defaultInvoiceValues: InvoiceFormValues = {
  ...
  from: {
    ...
    addressLines: ["Rua Pixel, 214", "Austin, TX 78701"],
    taxId: "WS-1029384756",
...
export const invoiceClients: InvoiceToDetails[] = [
  {
    ...
    addressLines: ["450 Park Avenue South", "New York, NY 10016", "Estados Unidos"],
  ...
  defaultInvoiceValues.to,
  {
    ...
    addressLines: ["Kastanienallee 32", "10435 Berlin", "Alemanha"],
