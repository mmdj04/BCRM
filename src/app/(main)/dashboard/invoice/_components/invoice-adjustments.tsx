      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_1.1fr]">
        <Controller
          ...
          render={({ field }) => (
            <Field className="gap-1">
              <FieldLabel className="text-xs">Imposto</FieldLabel>
        ...
        <div className="grid grid-cols-[1fr_112px] gap-4">
          <Controller
            ...
            render={({ field }) => (
              <Field className="gap-1">
                <FieldLabel className="text-xs">Desconto</FieldLabel>
                <Select value={field.value} onValueChange={field.onChange}>
                  <SelectTrigger className="h-10 w-full">
          ...
          <Field className="gap-1">
            ...
            <InputGroup>
              ...
              />
              <InputGroupAddon align="inline-end">{discountType === "fixed" ? "R$" : "%"}</InputGroupAddon>
            </InputGroup>
          </Field>
        </div>
      </div>
