...
export const patients = [
  {
    ...
    recentEvents: [
      ...
      { label: "Derivação II selecionada", time: "00:51" },
    ],
    respirationRate: 16,
    sex: "M",
    signalProfile: {
  ...
  },
  {
    ...
    nibp: "128/77",
    recentEvents: [
      { label: "ECG de 12 derivações completo", time: "01:15" },
  ...
  },
  {
    ...
    nibp: "118/74",
    recentEvents: [
      { label: "FC > 100", time: "01:26" },
      { label: "NIBP 118/74", time: "01:18" },
      { label: "Sonda de SpO₂ verificada", time: "00:48" },
    ],
    respirationRate: 20,
    sex: "M",
    signalProfile: {
  ...
  },
  {
    ...
    recentEvents: [
      ...
      { label: "Estimulação desligada", time: "00:36" },
    ],
    respirationRate: 15,
    sex: "F",
    signalProfile: {
  ...
  },
  {
    ...
    nibp: "124/72",
    recentEvents: [
      { label: "Revisão de ST concluída", time: "01:11" },
  ...
  },
  {
    ...
    recentEvents: [
      ...
      { label: "Balancemento hídrico atualizado", time: "00:57" },
    ],
    respirationRate: 17,
    sex: "F",
    signalProfile: {
  ...
  },
  {
    ...
    nibp: "120/72",
    recentEvents: [
      { label: "Local de acesso verificado", time: "01:16" },
  ...
  },
  {
    ...
    bed: "C09",
    diagnosis: "Pós-implante de marca-passo",
    heartRate: 74,
    id: "cardiac-09",
    map: 88,
    name: "Mia Romberg",
    nibp: "119/71",
    recentEvents: [
      { label: "Captura de estimulação verificada", time: "01:19" },
  ...
  },
  {
    ...
    bed: "C10",
    diagnosis: "Observação de NSTEMI",
    heartRate: 82,
    id: "cardiac-10",
    map: 92,
    name: "Alec Whitten",
    nibp: "126/74",
    recentEvents: [
      { label: "Enzimas cardíacas revisadas", time: "01:13" },
