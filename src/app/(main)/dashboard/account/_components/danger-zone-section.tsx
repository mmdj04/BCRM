  ...
  return (
    <Card className="border-destructive/50">
      ...
      <CardContent className="flex flex-col gap-4">
        {isDemo ? (
          <div className="rounded-lg border border-muted bg-muted/30 p-4 text-center text-muted-foreground text-sm">
            As ações de exclusão não estão disponíveis no modo de demonstração.
          </div>
        ) : (
          <>
            {/* Delete All Data */}
