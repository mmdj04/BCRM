    ...
    <Card size="sm" className="overflow-hidden shadow-none group-data-[collapsible=icon]:hidden">
      <CardHeader className="min-w-0 px-4">
        ...
        <CardDescription className="line-clamp-3">
          {t.supportBefore}{" "}
          <Link href="https://x.com/arhamkhnz" target="_blank" rel="noreferrer" aria-label={t.reachOut} className="inline-flex items-center text-foreground">
            <SimpleIcon icon={siX} aria-hidden className="size-3 fill-foreground" />
          </Link>{" "}{t.supportBetween}{" "}
          <Link href="https://github.com/arhamkhnz#want-to-connect" target="_blank" rel="noreferrer" className="text-foreground hover:underline">{t.email}</Link>.
        </CardDescription>
      </CardHeader>
    </Card>
  );
