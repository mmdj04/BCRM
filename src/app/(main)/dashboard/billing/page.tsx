...
export default function BillingPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Precos</h1>
        <p className="text-muted-foreground text-sm">Comece gratis, escale conforme cresce. Pague apenas pelo que usar.</p>
      </div>
