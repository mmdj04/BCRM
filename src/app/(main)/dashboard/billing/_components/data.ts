...
export const featureComparison: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      {
        name: "Requisições API ilimitadas",
        starter: "Incluso",
        pro: "Incluso",
        team: "Incluso",
        enterprise: "Incluso",
      ...
      {
        name: "Recuperação ponto a ponto",
        starter: "-",
        pro: "R$ 500/mês por 7 dias",
        team: "R$ 500/mês por 7 dias",
        enterprise: "R$ 500/mês por 7 dias",
      },
      ...
      { name: "Egress", starter: "5 GB", pro: "250 GB", team: "250 GB", enterprise: "Personalizado" },
      {
        name: "Pipelines",
        starter: "-",
        pro: "R$ 0,27/hora + R$ 15/GB",
        team: "R$ 0,27/hora + R$ 15/GB",
  ...
  },
  {
    ...
    features: [
      {
        name: "Usuários ativos mensais (MAUs)",
        starter: "50.000",
        pro: "100.000",
        team: "100.000",
        enterprise: "Personalizado",
      ...
      {
        name: "Propriedade dos dados do usuário",
        starter: "Incluso",
        pro: "Incluso",
        team: "Incluso",
        enterprise: "Incluso",
      ...
      {
        name: "Logs de auditoria de autenticação",
        starter: "1 hora",
        pro: "7 dias",
        team: "28 dias",
        enterprise: "Incluso",
      ...
      {
        name: "MFA avançado (Telefone)",
        starter: "-",
        pro: "R$ 375/mês primeiro projeto",
        team: "R$ 375/mês primeiro projeto",
        enterprise: "Personalizado",
      },
  ...
  },
  {
    ...
    features: [
      ...
      {
        name: "Controles de acesso personalizados",
        starter: "Incluso",
        pro: "Incluso",
        team: "Incluso",
        enterprise: "Incluso",
      ...
      },
      {
        ...
        starter: "CDN básico",
        pro: "CDN inteligente",
        team: "CDN inteligente",
        enterprise: "CDN inteligente",
      },
      {
        name: "Transformações de imagem",
        starter: "-",
        pro: "100 grátis",
        team: "100 grátis",
        enterprise: "Personalizado",
  ...
  },
  {
    ...
    features: [
      ...
      {
        name: "Retenção de logs (API e Banco)",
        starter: "1 dia",
        pro: "7 dias",
        team: "28 dias",
        enterprise: "90 dias",
      ...
      { name: "URLs personalizadas", starter: "-", pro: "Incluso", team: "Incluso", enterprise: "Incluso" },
      {
        ...
        starter: "-",
        pro: "R$ 50/domínio/mês",
        team: "R$ 50/domínio/mês",
        enterprise: "1 incluso",
      },
    ],
  },
  {
...
export const billingHistory: BillingHistoryEntry[] = [
  { id: "inv_001", date: "Ago 1, 2026", description: "Plano Pro - Mensal", amount: 1889.9, status: "paid" },
  { id: "inv_002", date: "Jul 1, 2026", description: "Plano Pro - Mensal", amount: 1889.9, status: "paid" },
  { id: "inv_003", date: "Jun 1, 2026", description: "Plano Starter - Mensal", amount: 789.9, status: "paid" },
  { id: "inv_004", date: "Mai 1, 2026", description: "Plano Starter - Mensal", amount: 789.9, status: "paid" },
];
...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Você pode criar um projeto separado para seu backend de desenvolvimento e produção. Nosso plano Starter oferece 2 projetos gratuitos.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sim, você pode pausar um projeto a qualquer momento. Nosso plano Starter oferece 2 projetos, mas você pode ter quantos projetos pausados quiser.",
  },
];
