  ...
  return (
    <div className="grid grid-cols-1 gap-4 *:data-[slot=card]:shadow-xs sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
      ...
      <Card>
        ...
        <CardContent className="flex size-full flex-col justify-between">
          <div className="space-y-1.5">
            <CardTitle>Projetos Ganhos</CardTitle>
            <CardDescription>Últimos 6 Meses</CardDescription>
          </div>
      ...
      <Card className="col-span-1 xl:col-span-2">
        <CardHeader>
          ...
          <CardDescription>Acumulado no Ano</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter>
          <p className="text-muted-foreground text-sm">+35% crescimento desde o último ano</p>
        </CardFooter>
      </Card>
    </div>
  );
